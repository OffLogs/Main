...
{
    public class SaveObjectWithIdCommand<THasId> : IAsyncCommand<SaveObjectWithIdCommandContext<THasId>>
        where THasId : class, IHasId, new()
    {
        private readonly IDbSessionProvider _sessionProvider;
        
        public SaveObjectWithIdCommand(IDbSessionProvider sessionProvider)
        {
